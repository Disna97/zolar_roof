...
class RequestGeneralService extends StatefulWidget {
  @override
  _RequestGeneralServiceState createState() => _RequestGeneralServiceState();
}

class _RequestGeneralServiceState extends State<RequestGeneralService> {
        ...
        child: Column(
          ...
          children: [
            ...
            Constants.buttonDesign(context, "Submit", (){
              ...
              context.read<ServiceProvider>().sendGeneralServiceData(context,
